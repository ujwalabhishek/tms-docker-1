            ...
            else 
            {
                ...
                {    
                   ...
                   // if($check_attendance<=0 || $check_competent>0)
                     if($check_competent>0)
                    {
                        $wsq_courses_array = array('95','115','67','66','65','98','100','97','101','102','103','127');// wsq courses
...
//        $data['trainee_count'] = $totalrows;
        $data['trainee_count'] = $total_trainee_enrolled;
        $data['pagination'] = get_pagination($records_per_page, $pageno, $baseurl, $totalrows, $field, $pag_sort);
            ...
            if ($mode_of_payment == '') {
               ...
               if($tenant_details->tenant_id == 'T12')
                ...
                $res['data'] = array('class' => $classes, 'trainee' => $trainee, 'classloc' => $ClassLoc,
                    ...
                    'coursemanager' => $tenant_details->contact_name, 'courselevel' => $courseLevel, 'tenant' => $tenant_details);
            }
        }
        echo json_encode($res);
        exit();
 ...
 * @return string
 */
function get_links($enrolment_mode, $payment_status, $invoice_id, $user_id, $pymnt_due_id, $class_id, $view_trainee_data, $trainee_Status,$classStatus,$company_id) {
