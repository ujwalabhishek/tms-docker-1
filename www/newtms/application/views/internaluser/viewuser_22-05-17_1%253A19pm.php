        ...
        <table class="table table-striped">
            <tbody>
                ...
                <tr>
                    ...
                    <td><label class="label_font"><?php echo $user_list_values->off_email_id; ?></label></td>
                </tr>
                <tr>
                ...
                if (count($training_details) > 0) {
                    foreach ($training_details as $item) :
                        ...
                        if ($user_list_values->account_status == 'PENDACT') {
                            ...
                            $linkStr .= get_links($item->enrolment_mode, $item->payment_status, $item->invoice_id, $item->user_id, $item->pymnt_due_id, $item->class_id, $this, $user_list_values->account_status, $classStatus);
                        }
                        ?>
                        <tr>                
...
function get_links($enrolment_mode, $payment_status, $invoice_id, $user_id, $pymnt_due_id, $class_id, $view_trainee_data, $trainee_Status,$classStatus) {
