<script src="<?php echo base_url() ?>/assets/js/edittenant.js" type="text/javascript"></script>
<div class="col-md-10" style="min-height: 400px;">
    ...
    <div class="table-responsive">
        ...
        echo form_open("manage_tenant/edit_tenant", $atr);
        ?>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <?php
                        $data = array(
                            'id' => 'search_tenant_name',
                            'name' => 'search_tenant_name',
                            'value' => $this->input->post('search_tenant_name'),
                            'style' => 'width:400px;'
                        );
                        ...
                        echo form_input($data);
                        echo '<span id="search_tenant_name_err"></span>';
                        ?>
                    </td>
    ...
    <br/>
    <div style="<?php echo(!empty($tenant)) ? '' : 'display:none'; ?>">
        <?php
        $atr = 'id="tenant_form" name="tenant_form"';
        echo form_open_multipart($controllerurl . "update_tenant", $atr);
        ?>
        <h2 class="sub_panel_heading_style"><img src="<?php echo base_url(); ?>assets/images/personal_details.png"> Tenant - Edit Details</h2>		  
                ...
                <table class="table table-striped">      
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td id="user_image_preview" class="td_heading" colspan="3">&nbsp;&nbsp;&nbsp;
                                <?php
                                $logo = $this->input->post('logo');
                                if (file_exists('./logos/' . $logo) && !empty($logo)) {
                                    ?>
                                    <img width="150px"  src="<?php echo base_url() . 'logos/' . $logo; ?>" id="imgprvw" border="0" />                
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                $data = array(
                                    ...
                                    'id' => 'paypal_email',
                                    'maxlength' => '50',
                                    'value' => $this->input->post('paypal_email_id'),
                                    'style' => 'width:250px',
                                );
                                echo form_input($data);
                                ?>
        ...
        <div class="button_class">
            <div class="button_class99">
                <button class="btn btn-primary" type="submit"><span class="glyphicon glyphicon-saved"></span>&nbsp;Update</button> &nbsp; &nbsp;
            </div>
        </div>
        <?php echo form_hidden('tenant_id', $this->input->post('tenant_id')); ?>
        <?php echo form_hidden('search_tenant_name', $this->input->post('search_tenant_name')); ?>
        <?php echo form_close(); ?>
    </div>
</div>