            ...
            <tr>
                <td colspan="2">
                    <span style="float:right;">
                        <a href="<?php echo base_url(); ?>reports/print_trainer_feedback?course_id=<?php echo $course_id ?>&class_id=<?php echo $class_id ?>&user_id=<?php echo $user_id ?>" class="small_text1">
