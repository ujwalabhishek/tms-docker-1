...
<div class="col-md-10">
    ...
    <div class="table-responsive">
        <?php
        $tenant_id = $this->session->userdata('userDetails')->tenant_id;//skm1
                ...
                foreach ($tabledata as $data) {
                    ...
                    echo '<tr>
                            ...
                            <td><span style="'.$paid_sty_arr[$data->payment_status].'">' . $paid_arr[$data->payment_status] . '</span></td>
                             <td><a href="' . base_url() . 'trainee/print_loc/' . $data->class_id . '/' . $data->user_id . '" style="color:red;">LOC</a><br/>
                            '.$linkStr.'    
                            </td>
                        </tr>';
                }
