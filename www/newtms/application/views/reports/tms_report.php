        ...
        <div class="bs-example">
            <div class="table-responsive">
                ...
                <?php if (count($result) > 0 && array_key_exists('EXP_XLS', $this->data['left_side_menu']['INTUSR'])) { ?>
                                            ...
                                            <a href="<?php echo site_url('/reports_finance/export_tms_report' . $export_url) ?>"  class="small_text1"><span class="label label-default black-btn"><span class="glyphicon glyphicon-export"></span> Export All Fields<?php echo $_POST['payStatus']?></span></a>
                <?php } ?>
                            </div>
