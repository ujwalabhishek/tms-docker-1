...
if($start_class!=$end_class  && $value_of_schedule_class>0)
{  // else condition on line no : 504
                        ...
                        <div class="add_button space_style">
                            ...
                            {  
                                ...
                                if( ($user->user_id==82169) || ($user->user_id==53401) || ($user->user_id==82171) || ($user->user_id==1) || ($user->user_id==2))
                                {
                                    ...
                                    {
                                        ?>
                                        <button id="unlock_attendance" class="label label-primary black-btn mar-bot" style="display:;">
