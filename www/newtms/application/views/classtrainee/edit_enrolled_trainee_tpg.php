        ...
        <table class="table table-striped">
            <tbody>
                ...
                <tr class="change_span" style="">
                    ...
                    <td>
                        <input type="text" name="change_taxcode_autocomplete" id="temail" style="" value='<?php echo $traineeEmailAddress; ?>'/>
                ...
                <tr class="new_span">
                    ...
                    <td>
                        <input type="text" name="courserunid" id="crunid" style="" value='<?php echo $courseRunId; ?>' />
                ...
                <tr class="new_span">
                    ...
                    <td colspan="3">
                        <input type="text" name="collection_status" id="collection_status" value='<?php echo $feeDiscountAmount; ?>' />
                ...
                <tr class="change_span" style="">
                    ...
                    <td>
                        <input type="text" name="tenant_email_id" id="tenant_email_id" style="" value='<?php echo $employerContactFullName; ?>' />
                    ...
                    <td> 
                        <input type="text" name="tenant_contact_num" id="tenant_contact_num" style="" value='<?php echo $employerContactNumber; ?>' />
                ...
                <tr class="change_span" style="">
                    ...
                    <td>
                        <input type="text" name="tenant_email_id" id="tenant_email_id" style="" value='<?php echo $employerEmailAddress; ?>' />
                        <span id="tenant_email_id_err"></span>
                    </td>
                </tr>
                <tr class="new_span">
