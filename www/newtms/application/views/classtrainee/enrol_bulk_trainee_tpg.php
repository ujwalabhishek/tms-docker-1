...
<div class="col-md-10 right-minheight">
    ...
    <h2 class="panel_heading_style"><span class="glyphicon glyphicon-list-alt"></span> TPG Trainee Bulk Enrollment</h2>
    ...
    <div class="table-responsive">
        ...
        echo form_open("tp_gateway/bulk_trainee_enrolment_data_tpg", $atr);
