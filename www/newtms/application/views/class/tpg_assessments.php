                        ...
                        foreach ($tabledata as $row) {
                            ...
                            <tr>                        
                                ...
                                <td>
                                    ...
                                    <br>
                                    <a href="#update_void_assessment" rel="modal:open" id='update_assessment' data-refNo='<?php $row->assessment_reference_No;?>' data-userid="<?php $row->user_id;?>" data-courseid="<?php $row->course_id;?>" data-classid="<?php $row->class_id;?>"><span class="btnblue">Update/Void Assessment</span></a>
                                    <br>
