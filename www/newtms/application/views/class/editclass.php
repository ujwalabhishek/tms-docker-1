...
<div class="col-md-10">
    ...
    <div style="color:red"> <b>Note: </b>Only Class/Course Run which are not submitted to tpg can be editable</div>
...
<!--                            <td class="td_heading">Sales Executive:</td>
        ...
        <div class="button_class">
            <?php if($class->tpg_course_run_id == ''){?><button class="btn btn-primary" type="submit"><span class="glyphicon glyphicon-retweet"></span>&nbsp;Update</button><?php }?> &nbsp; &nbsp; 
