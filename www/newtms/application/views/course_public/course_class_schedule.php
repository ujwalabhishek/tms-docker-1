                            ...
                            <tbody>
                                <?php
                                    ...
                                    foreach ($tabledata as $class):
                                        ...
                                        $class['user_id'] = $user_id;
                                        if(TENANT_ID == 'T02'){
                                            $enroll_link_prefix ='<a class="enroll_now_link" href="' . base_url() . 'course_public/class_member_check_elearning/' . $class['course_id']  . '" data-class="'.$class['class_id'].'" data-course="'.$class['course_id'].'">';
                                            $enroll_link_label = 'Enroll Now';
