            ...
            <table class="table table-striped">      
                <tbody>                
                    ...
                    <tr>
                        ...
                        ?>
                        <td colspan="5">
                            <?php echo form_dropdown('assign_company', $company_options, $trainee_id_name, 'id="assign_company" style="width:550px"');
                            ?>
                        </td>
                        <?php
                        }
                        ...
                        ?>
                        <td colspan="5">
                            <?php echo form_dropdown('assign_company', $company_options, $trainee['company']['company_id'], 'id="assign_company"');
                            ?>
                        </td>
                        <?php
                        }
...
//                        echo "Cert Sne t TO(".$trainee[userdetails]['cert_sent_to'].")";
                    ...
                    <tr id="cert_sent_t">
                        ...
                        <td colspan="5">
                            <?php
                            echo form_dropdown('cert_sent_to', $company_options, $trainee[userdetails]['cert_sent_to'], 'id="cert_sent_to" style="width:550px"');
                        ...
                        <td colspan="5">
                            <?php
                            if ($flag == 1) {
                            echo form_dropdown('cert_sent_to', $company_options, $trainee[userdetails]['cert_sent_to'], 'id="cert_sent_to"');
                            } else {
                            $data = array(
                            'name' => 'cert_sent_to_others',
                            'id' => 'cert_sent_to_others',
