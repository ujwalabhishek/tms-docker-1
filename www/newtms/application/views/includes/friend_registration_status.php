                        ...
                        <div class="table-responsive">
                            <div class="col-md-12 min-pad warng">
                                <?php if($message == 'success') { ?>
                                    ...
                                    <h3 class="success-title">For Referring your friend/family with '<?php echo $tenant_details->tenant_name; ?>'.  </h3>
                                   
                                    Kindly click on this  <a href="<?php echo base_url();?>user/referral_list"> link</a> to view the referral list. <br/>
                                        </p>                         
                                <?php } else { ?>
