                ...
                if (count($training_details) > 0) {
                    foreach ($training_details as $item) :
                        ...
                        if ($trainee['userdetails']['account_status'] == 'PENDACT') {
                            ...
                            $linkStr = get_links($item->enrolment_mode, $item->payment_status, $item->invoice_id, $item->user_id, $item->pymnt_due_id, $item->class_id, $this, $trainee['userdetails']['account_status'],$item->company_id,$assmnt_links);
...
function get_links($enrolment_mode, $payment_status, $invoice_id, $user_id, $pymnt_due_id, $class_id, $view_trainee_data, $trainee_Status,$classStatus,$company_id, $assmnt_links) {
