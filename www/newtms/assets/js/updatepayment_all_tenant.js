...
//                alert(data);
                ...
                alert("Original due "+data.total_inv_amount);
                ...
                $.each(trainee, function(i, item) {
                    ...
                    $x = parseFloat(item.amount_remain).toFixed(2);
                    alert("amount="+$x)
                    if (item.payment_status == 'NOTPAID') {
                        $status = '<span class="error">Not Paid</span>';
                        $payment_progress = 
                        '<span class="actual_pay_' + item.user_id + '"> ' + parseFloat(item.amount_remain).toFixed(3) + '</span>\
                        <input type="hidden" value="' + parseFloat(item.amount_remain).toFixed(3) + '" name="amount_check[' + item.user_id + ']"/>\
                        <span style="display:none;" class="actual_payenter_' + item.user_id + '">\n\
                        <input type="text" value="' + parseFloat(item.amount_remain).toFixed(3) + '" name="amount_paying[' + item.user_id + ']" class="amount_paying"/></span>';
                        ...
                        $payment_progress = '<span style="display:none;" class="actual_pay_' + item.user_id + '"> ' + parseFloat(item.amount_remain).toFixed(3) + '</span>\
                                        <input type="hidden" value="' + parseFloat(item.amount_remain).toFixed(3) + '" name="amount_check[' + item.user_id + ']"/>\
                                        <span class="actual_payenter_' + item.user_id + '"><input type="text" value="' + parseFloat(item.amount_remain).toFixed(3) + '" name="amount_paying[' + item.user_id + ']" class="amount_paying"/></span>';
                        ...
                        $payment_progress = '<span class="actual_pay_' + item.user_id + '"> ' + parseFloat(item.amount_remain).toFixed(3) + '</span>\
                                        <input type="hidden" value="' + parseFloat(item.amount_remain).toFixed(3) + '" name="amount_check[' + item.user_id + ']"/>\
                                        <span style="display:none;" class="actual_payenter_' + item.user_id + '"><input type="text" value="' + parseFloat(item.amount_remain).toFixed(4) + '" name="amount_paying[' + item.user_id + ']" class="amount_paying"/></span>';
                    ...
                    $html = '<tr>\
                                    ...
                                    <td> ' + parseFloat(item.total_amount_due).toFixed(3) + '</td>\
                                    <td> ' + parseFloat(item.amount_paid).toFixed(3) + '</td>\
                                    <td> ' + parseFloat($user_refunded).toFixed(3) + '</td>\
                ...
                if (cnt > 1) {
                    $company_total = parseFloat($company_total).toFixed(3);

                    $company_total_due = parseFloat($company_total_due).toFixed(3);
                    $company_total_paid = parseFloat($company_total_paid).toFixed(3);
                    ...
                    alert("Current due "+data.$company_total);
                    $('.c_current_due').html(parseFloat($company_total).toFixed(2));
                  // $('.c_invoice_net_due').html(parseFloat(data.total_inv_amount).toFixed(2)); orignal
//                   $('.c_current_due').html(parseFloat(data.total_inv_amount).toFixed(2));
                }
