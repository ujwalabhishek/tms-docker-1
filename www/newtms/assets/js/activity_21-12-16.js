...
//    }
    ...
    jQuery("#internal_staff").autocomplete({
            ...
            $('#staff_id').val('');
            jQuery.get(baseurl + "activity_log/get_internalstaff_name_autocomplete", {
                query: request.term,
                dataType: "json"
            }, function(data) {
        ...
        jQuery("#company").autocomplete({
            source: function(request, response) {
            $('#com_id').val('');
            jQuery.get(baseurl + "activity_log/get_companyname_autocomplete", {
                query: request.term,
                dataType: "json"
            }, function(data) {
                var d = jQuery.parseJSON(data);
        ...
        jQuery("#course").autocomplete({
            source: function(request, response) {
            $('#crse_id').val('');
            jQuery.get(baseurl + "activity_log/get_coursename_autocomplete", {
                query: request.term,
                dataType: "json"
            }, function(data) {
                var d = jQuery.parseJSON(data);
        ...
        jQuery("#inv_taxcode").autocomplete({
            source: function(request, response) {
            $('#invid').val('');
            jQuery.get(baseurl + "activity_log/get_invtaxcode_autocomplete", {
                query: request.term,
                dataType: "json"
            }, function(data) {
                var d = jQuery.parseJSON(data);
        ...
        jQuery("#inv").autocomplete({
            source: function(request, response) {
            $('#invoice').val('');
            jQuery.get(baseurl + "activity_log/get_inv_autocomplete", {
                query: request.term,
                dataType: "json"
            }, function(data) {
                var d = jQuery.parseJSON(data);
        ...
        jQuery("#pass").autocomplete({
            source: function(request, response) {
//            $('#invoice').val('');
            jQuery.get(baseurl + "activity_log/get_password_autocomplete", {
                query: request.term,
                dataType: "json"
            }, function(data) {
                var d = jQuery.parseJSON(data);
        ...
        $.ajax({
            type: 'post',
            url: $baseurl + 'activity_log/get_course_class_name_json',
