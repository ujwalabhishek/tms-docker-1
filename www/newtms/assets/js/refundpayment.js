...
function form_validate($retVal) {
    ...
    else if ($payment_type == 'SFC_SELF') 
    {
		...
		$remaining_amt=parseFloat($remaining_amt).toFixed(2);///////////////////////////shubhranshu Fixed for refund issue 14/11/2018 at 3:46PM/////////////////////
...
//        $('.refund_save').val('Please Wait..');
		//////////////////////////////////////////SHUBHRANSHU fixed for button please wait issue////////////////////////////////////////////////////////////////////////////
        $('.refund_save').val('Submit');
		//////////////////////////////////////////SHUBHRANSHU////////////////////////////////////////////////////////////////////////////
    }
    return $retVal;
}
